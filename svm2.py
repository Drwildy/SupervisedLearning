...
train_scores, test_scores = validation_curve(
    model, X_train, y_train, param_name='gamma', param_range=param_range, cv=3, scoring='accuracy')
...
param_range = np.array([1, 10, 30, 50, 70, 90, 110, 130, 150])
train_scores, test_scores = validation_curve(
...
fig2 = optuna.visualization.plot_slice(study, params=['C'])
fig2.show()
